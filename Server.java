...
ImageIcon imageIconThree=new ImageIcon(ClassLoader.getSystemResource("icons/1.png"));
...
JLabel labelThree=new JLabel("Anshul");
...
printWriter.println("Anshul :"+message);
...
{
new Server().frameOne.setVisible(true);

String messageInput="";

try
{
serverSocket=new ServerSocket(7072);
